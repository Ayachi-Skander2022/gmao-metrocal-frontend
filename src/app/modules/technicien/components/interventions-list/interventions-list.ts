...
@Component({
  ...
  styleUrl: './interventions-list.scss'
...
export class InterventionsList implements OnInit {
  ...
  loadInterventions(): void {
    ...
    this.service.getInterventionsByTechnicien(technicienId).subscribe((data: Intervention[]) => {
