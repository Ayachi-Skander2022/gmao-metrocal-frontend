...
ngOnInit(): void {
  ...
  this.registerIntervenant = this.fb.group({
...
submitForm() {
  if (this.registerIntervenant.invalid) return;

  this.authService.registerI(this.registerIntervenant.value).subscribe({
    next: res => {
